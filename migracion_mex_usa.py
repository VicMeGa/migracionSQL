#!/usr/bin/env python3
# =============================================================================
# migracion_mex_usa.py — Script A: Migración MEX → USA
#
# Uso:
#   python migracion_mex_usa.py /ruta/al/archivo.xml
#
# Contexto:
#   - pais_origen  = 'mex'
#   - origen de clientes nuevos = 'mex'
#   - Etiquetas ambiguas resuelven hacia sucursales MEX
#   - Actualiza envios_mex_sequence al finalizar
#
# Antes de ejecutar:
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("migracion_mex_usa.log", encoding="utf-8"),
    ],
)
logger = logging.getLogger("migracion_mex_usa")
...
PAIS_ORIGEN    = "mex"
ORIGEN_CLIENTE = "mex"
ETIQUETAS_CTX  = ETIQUETAS_AMBIGUAS_MEX   # diccionario de desambiguación MEX
...
def migrar(ruta_xml):
    ...
    logger.info("")
    logger.info("=" * 60)
    logger.info("RESUMEN DE MIGRACIÓN MEX → USA")
    logger.info("=" * 60)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Uso: python migracion_mex_usa.py /ruta/al/archivo.xml")
        sys.exit(1)
